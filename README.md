...
| CPU                  | 操作系统            | 编译器    | 优化等级 |
| -------------------- | ------------------- | --------- | -------- |
| i5-6300U （2.40GHZ） | Ubuntu 16.04（WSL） | G++-5.4.0 | O3       |
...
zzzJSON从多方面测试其解析和序列化速度，主要包括：无数字数据测试、nativejson-benchmark数据测试、淘宝数据测试和混合数据测试，每个测试分别测试解析耗时、序列化耗时和全部耗时，其中全部耗时包括创建对象、解析、序列化和析构的耗时总和，详细的代码在 performance_test.cpp 文件中。以上测试包含了C/C++的主流JSON解析器，其中RapidJSON开启了SIMD。zzzJSON不使用SIMD的主要原因是：1. 不能使用相同的二进制统一部署；2. 增加代码复杂度。

#### 性能调优

由于测试的数据比较大，所以zzzJSON对内存参数进行了调优，会提高性能，具体如下：

```c
#define ZZZ_ALLOCATORINITMEMSIZE 4096 * 16 // 内存分配器初次分配内存大小
#define ZZZ_STRINGINITMEMSIZE 4096 * 4     // 字符串初次大小
#define ZZZ_DELTA 4                        // 内存不够时，内存翻倍数
```
...
| cJSON           | 75              | 45              | 128              |
| gason           | 22              | 138             | 172              |
| picoJSON        | 417             | 131             | 609              |
| JSONCPP         | 448             | 270             | 768              |
| nlohmannJSON    | 494             | 155             | 671              |
| taocppJSON      | 493             | 162             | 643              |
| rapidJSON       | 129             | 31              | 182              |
| rapidJSONFP     | 62              | 31              | 94               |
| rapidJSONSTR    | 56              | 22              | 85               |
| zzzJSON         | 37              | 16              | 56               |
...
| 解析器名字   | 解析耗时 | 序列化耗时 | 全部耗时 |
| ------------ | -------- | ---------- | -------- |
| ArduinoJSON     | 1040            | 32              | 1101             |
| cJSON           | 57              | 269             | 325              |
| gason           | 7               | 106             | 126              |
| picoJSON        | 108             | 161             | 279              |
| parsonJSON      | 81              | 419             | 515              |
| JSONCPP         | 115             | 170             | 309              |
| nlohmannJSON    | 92              | 26              | 129              |
| taocppJSON      | 39              | 33              | 90               |
| rapidJSON       | 10              | 18              | 30               |
| rapidJSONFP     | 32              | 17              | 49               |
| rapidJSONSTR    | 28              | 8               | 47               |
| zzzJSON         | 7               | 3               | 9                |
...
| 解析器名字   | 解析耗时 | 序列化耗时 | 全部耗时 |
| ------------ | -------- | ---------- | -------- |
| ArduinoJSON     | 31              | 65              | 115              |
| cJSON           | 32              | 18              | 50               |
| gason           | 5               | 54              | 69               |
| picoJSON        | 114             | 54              | 172              |
| parsonJSON      | 70              | 108             | 192              |
| JSONCPP         | 55              | 52              | 123              |
| nlohmannJSON    | 63              | 28              | 122              |
| taocppJSON      | 30              | 30              | 70               |
| rapidJSON       | 18              | 11              | 28               |
| rapidJSONFP     | 14              | 8               | 26               |
| rapidJSONSTR    | 17              | 10              | 23               |
| zzzJSON         | 9               | 3               | 10               |
...
| 解析器名字   | 解析耗时 | 序列化耗时 | 全部耗时 |
| ------------ | -------- | ---------- | -------- |
| ArduinoJSON     | 2355            | 737             | 3240             |
| cJSON           | 345             | 473             | 804              |
| gason           | 92              | 611             | 722              |
| picoJSON        | 936             | 570             | 1648             |
| parsonJSON      | 511             | 1170            | 1827             |
| JSONCPP         | 654             | 614             | 1446             |
| nlohmannJSON    | 783             | 315             | 1262             |
| taocppJSON      | 390             | 252             | 768              |
| rapidJSON       | 137             | 117             | 248              |
| rapidJSONFP     | 156             | 105             | 276              |
| rapidJSONSTR    | 139             | 104             | 261              |
| zzzJSON         | 96              | 60              | 167              |
