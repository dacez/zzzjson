...
#define TAOCPP_JSON_PEGTL_STRING( x ) TAO_JSON_PEGTL_STRING( x )
#define TAOCPP_JSON_PEGTL_ISTRING( x ) TAO_JSON_PEGTL_ISTRING( x )
#define TAOCPP_JSON_PEGTL_KEYWORD( x ) TAO_JSON_PEGTL_KEYWORD( x )
